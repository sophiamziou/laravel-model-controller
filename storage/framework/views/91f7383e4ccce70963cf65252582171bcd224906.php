<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center col-md-2 mb-2 mb-md-0 text-dark text-decoration-none">
        <img src="<?php echo e(Vite::asset('resources/img/images/dc-logo.png')); ?>" alt="LOGO">
      </a>
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="<?php echo e(route('comics')); ?>" class="nav-link px-2 link-dark">COMICS</a></li>
  ...
  </div><?php /**PATH /Users/sophiamziou/Desktop/esercizi Boolean/laravel-model-controller/resources/views/partials/header.blade.php ENDPATH**/ ?>